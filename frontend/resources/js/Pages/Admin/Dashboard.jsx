            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            <h3 className="text-lg font-bold text-gray-900 mb-4">New Schools (7 Days)</h3>
                            <div className="h-56 flex items-center justify-center">
                                <div className="text-center">
                                    <p className="text-4xl font-black text-indigo-600">{activity.schools_7d ?? 0}</p>
                                    <p className="text-xs uppercase tracking-widest text-gray-400 mt-2">Schools created</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                            ...
                            <div className="h-56 flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-xs uppercase tracking-widest text-gray-400 mt-2">Schools awaiting approval</p>
                                </div>
                            </div>
                        </div>
                    </div>
