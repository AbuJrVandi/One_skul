...
class PublicApplicationController extends Controller
{
    ...
    public function form(School $school, Request $request)
    {
        ...
        if (!in_array($category, ['primary', 'jss', 'sss'])) {
            return to_route('public.applications.start', $school->slug);
        }
    ...
    public function storeForm(School $school, Request $request)
    {
        ...
        try {
            ...
            return to_route('public.applications.review', ['school' => $school->slug, 'ref' => $reference]);
        } catch (\Exception $e) {
            DB::rollBack();
            report($e);
    ...
    public function review(School $school, $ref)
    {
        ...
        if (!in_array($application->status, ['draft'])) {
            return to_route('public.applications.confirmation', ['school' => $school->slug, 'ref' => $ref]);
        }
    ...
    public function confirmReview(School $school, $ref, Request $request)
    {
        ...
        return to_route('public.applications.payment', ['school' => $school->slug, 'ref' => $ref]);
    }
