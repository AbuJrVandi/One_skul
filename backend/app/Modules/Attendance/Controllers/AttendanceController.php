...
class AttendanceController extends Controller
{
    ...
    public function index(Request $request, $schoolClass)
    {
        ...
        if (!$this->teacherAssignedToClass($teacher->id, $schoolClass->id)) {
    ...
    public function store(Request $request, $schoolClass)
    {
        $teacher = $this->getTeacher();
        $schoolClass = SchoolClass::findOrFail($schoolClass);
        ...
        $validated = $request->validate([
            ...
            'attendance.*.student_id' => [
                'required',
                Rule::exists('tenant.students', 'id')
