...
class StudentController extends Controller
{
    public function dashboard()
    {
        ...
        $decisionDocuments = [];
        if ($student) {
            $decisionDocuments = StudentDecisionDocument::where('student_id', $student->id)
    ...
    public function decisionDocument($document): BinaryFileResponse
    {
        $user = auth()->user();
        $student = Student::where('user_id', $user->id)->firstOrFail();

        $document = StudentDecisionDocument::findOrFail($document);
